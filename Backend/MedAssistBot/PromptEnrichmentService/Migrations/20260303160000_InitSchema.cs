    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql($$"""
            ...
            VALUES
                ...
                ('{{TechnicalTemplateCodes.SubSpec}}', 'Technical: subspec', 'вопрос в контексте специализации {subspec}'),
                ('{{TechnicalTemplateCodes.SpecList}}', 'Technical: spec_list', 'Список доступных специализаций {spec_codes}'),
